  ...
  return _createClass(GameSavingLoader, null, [{
    ...
    value: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var data, jsonData, parsedData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0,_reader__WEBPACK_IMPORTED_MODULE_0__["default"])();
            case 3:
              data = _context.sent;
              _context.next = 6;
            ...
            case 6:
              ...
              return _context.abrupt("return", new _GameSaving__WEBPACK_IMPORTED_MODULE_2__["default"](parsedData.id, parsedData.created, parsedData.userInfo));
            case 11:
              _context.prev = 11;
